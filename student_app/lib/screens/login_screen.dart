...
/// 4c — Student login. Accounts are provisioned by the SG; signs in against
/// Supabase Auth. Without backend config the sign-in button surfaces a
/// clear configuration error — never a fake session.
